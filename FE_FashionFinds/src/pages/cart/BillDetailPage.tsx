...
const BillDetail = () => {
    ...
    return (
        <div className="bg-[#f5f5f5]">
            <div className="md:w-[1250px] mx-auto grid md:grid-cols-[250px,auto] py-6">
                <div>
                                                    ...
                                                    return (
                                                        <div key={index}>
                                                            ...
                                                            {item?.products?.map((pro: any, index: string) => {
                                                                return (
                                                                    <div key={index} className="cart-List grid md:grid-cols-[800px,auto] flex items-center">
                                                            ...
                                                            <div className="flex gap-2 ">
                                                                ...
                                                                {item.status === "Delivering" || item.status === "Delivered" ? '' : <button
                                                                    onClick={() => onHandRemoveBill(item?._id)}
                                                                    className="bg-red-500 text-white max-w-[140px] border-gray-300 hover:bg-red-600 transition-all rounded-md w-full  py-2"
                                                                >Hủy</button>}
                                                                <Link
                                                                    to="/"
                                                                    className="bg-red-500 text-center hover:text-white text-white max-w-[140px] border-gray-300 hover:bg-red-600 transition-all rounded-md w-full  py-2"
                                                                >Đánh giá</Link>
                                                            </div>
                                                        </div>
                                                    )
