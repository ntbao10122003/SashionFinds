    ...
    return (
        <div>
            <form className="flex items-center mr-auto" onSubmit={handleSubmit(onHandlesSearch)}>
                ...
                <input
                    className="block w-full h-10 z-[100px]  bg-black text-white px-5 py-2 outline-none hover:border-secondary border  hover:border duration-200 rounded-s-lg"
                    type="text"
                    placeholder="Tim kiếm..." {...register("_keywords")}
                ...
                <button id="clickShowProduct"
                    type="submit"
                    className="px-3 py-2  rounded d-r-lg text-white"
                    aria-label="Justify"
            ...
            {isSearch &&
                <div className="rounded-md z-50 absolute md:w-[530px] mt-5" id="listProduct">
                                                ...
                                                <div className="">
                                                    <Link to="">
                                                        <img
                                                            ...
                                                            alt="ảnh"
                                                            className="transition duration-200 ease-in-out hover:scale-105 md:h-[30px] w-[30px] md:w-[30px]"
                                                        />
                                                    </Link>
                                                </div>
